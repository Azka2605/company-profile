...
export default function DesainPoster() {
    return (
        <Layout>
            <section className="bg-white py-20 px-6 text-center border-b border-gray-100">
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Desain Poster</h1>
                <p className="text-gray-500 max-w-xl mx-auto text-lg">
                    Kompetisi desain poster kreatif bertema teknologi dan kelistrikan.
                </p>
            </section>
            ...
            <section className="py-16 px-6 bg-gray-50">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        { icon: '👤', label: 'Tipe', value: 'Individu' },
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {['Mahasiswa aktif', 'Individu', 'Format PNG/PDF', 'Mengisi formulir pendaftaran'].map((item, i) => (
                        ...
                        {[
                            ...
                            <div key={i} className="flex gap-6 items-start">
                                <div className="flex flex-col items-center">
                                    <div className="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center font-bold text-gray-900">{i + 1}</div>
            ...
            <section className="py-16 px-6 bg-yellow-50 text-center">
                ...
                <p className="text-gray-500 mb-8">Daftarkan dirimu sekarang!</p>
                <Link href={route('competition.register', { type: 'desain_poster' })}
