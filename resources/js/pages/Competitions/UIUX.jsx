    ...
    return (
        <Layout>
            <section className="bg-white py-20 px-6 text-center border-b border-gray-100">
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">UI/UX</h1>
                <p className="text-gray-500 max-w-xl mx-auto text-lg">
                    Kompetisi desain antarmuka yang intuitif, menarik, dan berpusat pada pengguna.
                </p>
            </section>
            ...
            <section className="py-16 px-6 bg-gray-50">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        { icon: '👥', label: 'Tipe', value: 'Tim (1-2 orang)' },
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {['Mahasiswa aktif', 'Tim 1-2 orang', 'Figma / Adobe XD', 'Mengisi formulir pendaftaran'].map((item, i) => (
            ...
            <section className="py-16 px-6 bg-yellow-50 text-center">
                ...
                <Link href={route('competition.register', { type: 'uiux' })}
